            ...
            <div className='unit-content'>
                ...
                <div className='unit-exercise'>
                    ...
                    <div className="unit-exercise-image">
                        <img src={"inf130/ReferenciasEjercicio1.jpg"} className='unit-image' alt="Referencias Ejercicio 1"/>
                    </div>
                </div>
                <p>
                ...
                <div className='unit-exercise'>
                    ...
                    <div className="unit-exercise-image">
                        <img src={"inf130/ReferenciasEjercicio2.jpg"} className='unit-image' alt="Referencias Ejercicio 2"/>
                    </div>
                </div>
                <p>
                ...
                <div className='unit-exercise'>
                    ...
                    <div className="unit-exercise-image">
                        <img src={"inf130/ReferenciasEjercicio3.jpg"} className='unit-image' alt="Referencias Ejercicio 3"/>
                    </div>
                </div>
            </div>
        </div>
