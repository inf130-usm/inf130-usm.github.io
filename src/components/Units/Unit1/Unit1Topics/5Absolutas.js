        ...
        <div id='u1-absolutas'>
            ...
            <div className='unit-content'>
                ...
                <div className='unit-image'>
                    <img src={"./images/ReferenciasAbsolutas-Figura1.jpg"} alt="Referencias Absolutas Figura 1"/>
                    <div className='unit-caption'>
                        <label>Figura 3</label>
                    </div>
                </div>
                <div className='unit-image'>
                    <img src={"./images/ReferenciasAbsolutas-Figura2.png"} alt="Referencias Absolutas Figura 2"/>
                    <div>
