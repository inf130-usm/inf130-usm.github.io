        ...
        <div id='u1-relativas'>
            ...
            <div className='unit-content'>
                ...
                <div className='unit-image'>
                    <img src={"inf130/ReferenciasRelativas-Figura1.jpg"} alt="Referencias Relativas Figura 1"/>
                    <div className='unit-caption'>
                        <label>Figura 1</label>
                    </div>
                </div>
                <div className='unit-image'>
                    <img src={"inf130/ReferenciasRelativas-Figura2.jpg"} alt="Referencias Relativas Figura 2"/>
                    <div>
