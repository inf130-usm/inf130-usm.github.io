        ...
        <div className='unit'>
            ...
            <div className='unit-content'>
                ...
                <div className="unit-image">
                    <img src={"/inf130/SintaxisFunction.png"} className='unit-image' alt="Sintáxis del procedimiento Function"/>
                </div>
                <p>
                ...
                <div className="unit-image2">
                    <img src={"/inf130/FunctionSuma.png"} className='unit-image' alt="Ejemplo de una Function"/>
                </div>
                <p>
                Finalizada ya la función, es posible usarla de la misma forma que las funciones predefinidas de Excel
                </p>
                <div className="unit-image3">
                    <img src={"/inf130/FunctionEjemplo.png"} className='unit-image' alt="Modo de uso de Functions"/>
                </div>
                <p>
                ...
                <div className="unit-image2">
                    <img src={"/inf130/FunctionEnSub.png"} className='unit-image' alt="Modo de uso de Functions en subrutinas"/>
                </div>
                <p>
